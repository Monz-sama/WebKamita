			...
			columns: [
				...
				},
				{
					...
					render: function (data, type, row ) {
						//var ip = data;
						var ipTemplate = '<?php wpToolsSAFHelperClass::getIpInfo('@@IP@@');?>';
						return ipTemplate.replace(/@@IP@@/g, row.ip);
					}
				},
				{
					data: 'type'
				...
				},
				{
					...
					?>"'
									...
									+ '</button>'
									<?php if( !WPTSAF_PRO ){ ?>
										+'<span class="label label-info saf-label-button"><?php _e('pro', 'wptsaf_security'); ?></span>'
									<?php } ?>
								+'</div>';
					}
				}
