...
Contributors: msoftplugins
Donate link: http://wptools.co/security-antivirus-firewall/#pricing
Tags: security, google captcha, captcha, antivirus, firewall, network monitor, login, notification, brute force, malware, ddos attacks, S.A.F., protect files, 404, bruteforce, auto update, login security, security plugin
...
In our plugin you can find Life System Monitor module where you can see all changes and action of every security module. Settings of life security system monitor you can find on top of moodule, when click on settings button.  

= How to enable protection? =

In plugin settings you can enable/disable notification

= Is it possible to set custom email for notification? =

Yes, it's possible to define in plugin settings email where you wish to get notifications and this email could be different from admin profile email

== Screenshots ==

1. Security, Antivirus, Firewall - S.A.F : Bute force monitor.
2. Security, Antivirus, Firewall - S.A.F : 404 Detection, Live system monitor, Firewall, Brute force, Easy password.
3. Security, Antivirus, Firewall - S.A.F : Network monitor.
4. Security, Antivirus, Firewall - S.A.F : 404 Detection.
5. Security, Antivirus, Firewall - S.A.F : Easy password and auto update.
6. Security, Antivirus, Firewall - S.A.F : Firewall (network monitor).
7. Security, Antivirus, Firewall - S.A.F : Auto update settings.
8. Security, Antivirus, Firewall - S.A.F : Google captcha (recaptcha).
9. Security, Antivirus, Firewall - S.A.F : Live system monitor.
10. Security, Antivirus, Firewall - S.A.F : Brute force monitor settings.
11. Security, Antivirus, Firewall - S.A.F : Firewall settings.
12. Security, Antivirus, Firewall - S.A.F : Firewall IP's manager.
13. Security, Antivirus, Firewall - S.A.F : Firewall detailed log.
14. Security, Antivirus, Firewall - S.A.F : Googla captcha settings.

== Changelog ==

= Version 2.3.1 =
*  Added new ip whois detailed service
*  New fast dtected IP details 

= Version 2.3.0 =
*  Added new module to hide wordpress info
...
= Version 2.1.23 =
*  Update information block, modification of the notification module

= Version 2.1.22 =
*  Updated notification elements in backend listing
*  Interface modification

= Version 2.1.21 =
*  Updated interface of the event listings
*  Show/hide details of security events

= Version 2.1.20 =
*  Updated statistic module on dashboard
*  Update of the dashboard tooltip 

= Version 2.1.19 =
*  Added new graphic to the dashboard
*  Added new statistics info to the dashboard widget

= Version 2.1.18 =
*  Widget update, changed code strucure, added templates

= Version 2.1.17 =
*  Security widget code optimization

= Version 2.1.16 =
*  Updated dashboard widget functionoality
*  Added information about detected issues

= Version 2.1.15 =
*  Plugin code optimization

= Version 2.1.14 =
*  Added new widget to the wordpress dashboard
*  Added information about published and unpublished modules to the widget

= Version 2.1.13 =
*  Added to the firewall new self IP ban protection function

= Version 2.1.12 =
*  New check for required PHP libs support
*  Notification in the case if CURL lib do not installed on your server

= Version 2.1.11 =
*  Update network monitor IP deny manager
*  Added new IP function list auto refresh

= Version 2.1.10 =
*  Update of the email report structure
*  Report email subject fix 

= Version 2.1.9 =
*  Update of the email notification report functionality

= Version 2.1.8 =
*  Implemented support of the old PHP versions

= Version 2.1.7 =
*  Added new plugin settings configuraton wizard

= Version 2.1.6 =
*  Added new email report functionality
*  Daily, weekly, monthly security report

= Version 2.1.5 =
*  Fixed virus scanner ordering problem

= Version 2.1.4 =
*  Added new ban buttons to the network monitor module
*  Fixed extra whitespace in textarea

= Version 2.1.3 =
*  Added new new ban button in brute force module
*  Code optimization
...
= Version 2.1.1 =
*  Fixed code errors
*  Fixed plugin updated procedure

= Version 2.1.0 =
*  Added new Antivirus module
*  Added new Cloud Antivirus Monitor module

= Version 2.0.2 =
*  Fixed code conflict in admin interface of the plugin
*  Update of the module interface elements

= Version 2.0.1 =
*  Fixed code of the plugin
*  Update in admin interface 

= Version 2.0.0 =
*  Added new module Live System Monitor (system log)
*  Added new module Firewall (Network Monitor)
*  Added new module Brute Force Monitor
*  Added new module 404 Detector
*  Added new module Easy Password
*  Added new module Google Captcha
*  Added new module Auto Update
*  Added new module Cron Scheduler

= 1.0.0 =
New release of the admin plugin
