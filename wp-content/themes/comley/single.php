<?php get_header(); ?>     
    ...
    <div class="container">
      ...
      <?php if(isset($sidebar)&&$sidebar=='singlefullwidth'){
		  $singleclass='col-md-12 col-sm-12 col-xs-12';
	  }
	  else
	  {
		  $singleclass='col-md-8 col-sm-8 col-xs-12';
	  }
	  ?>
      ...
      <aside class="col-md-4 col-sm-4 col-xs-12 leftbar">
        ...
        <?php }?>
      <?php if(have_posts()): ?>
      <article class="<?php echo esc_attr($singleclass);?>">              
             <?php
		// Start the loop.
