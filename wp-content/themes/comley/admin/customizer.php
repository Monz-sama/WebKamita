...
array(
    'type' => 'radio',
    'label' => __('Single Blog Width', 'comley'),
    'section' => 'blog_setting_section',
    'choices' => array(
        'singlefullwidth' => esc_html__('Single Blog Full Width', 'comley'),
        'singlerightsidebar' => esc_html__('SingleBlog with Right Sidebar', 'comley'),
        'singleleftsidebar' => esc_html__('Single Blog with Left Sidebar', 'comley')
    ),
)
);
//
...
array(
    'type' => 'checkbox',
    'label' => __('Show footer social icon', 'comley'),
    'section' => 'theme_setting_section',
)
);
$wp_customize->add_setting(
